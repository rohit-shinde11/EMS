...
public class AddEmployee extends JFrame implements ActionListener {
    ...
    JTextField tfname, tffname, tfsalary, tfaddress, tfemail, tfphone, tfdesignation, tfaadhar;
    JDateChooser dcdob;
    ...
    AddEmployee(){
        ...
        String courses[] = {"BSC-CS", "BCA", "BA", "B.Com", "BTech", "BBA", "MSC-CS", "MCA", "MBA", "MTech", "Bsc", "Msc", "PHD"};
